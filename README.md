...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-06 16:40`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/be546403-c9a5-4cb3-a2c7-0449727e409c.git
$ cd be546403-c9a5-4cb3-a2c7-0449727e409c
```
